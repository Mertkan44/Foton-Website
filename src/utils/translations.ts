export const translations = {
  en: {
    ...
    contact: { title1: "Let's start", title2: "a conversation.", desc: "Reach out for technical inquiries.", email: "Email", visit: "Visit", f_name: "Name", f_mail: "Email", f_subj: "Subject", f_msg: "Message", btn: "Send" },
  ...
  tr: {
    ...
    contact: { title1: "Bir görüşme", title2: "başlatalım.", desc: "Teknik sorularınız için bize ulaşın.", email: "E-posta", visit: "Adres", f_name: "Ad Soyad", f_mail: "E-posta", f_subj: "Konu", f_msg: "Mesaj", btn: "Gönder" },
  ...
  de: {
    ...
    contact: { title1: "Kontaktieren", title2: "Sie uns.", desc: "Wir freuen uns auf Ihre Anfrage.", email: "E-Mail", visit: "Besuch", f_name: "Name", f_mail: "E-Mail", f_subj: "Betreff", f_msg: "Nachricht", btn: "Senden" },
  ...
  es: {
    ...
    contact: { title1: "Empecemos", title2: "a hablar.", desc: "Contacte con nosotros para consultas.", email: "Email", visit: "Visita", f_name: "Nombre", f_mail: "Email", f_subj: "Asunto", f_msg: "Mensaje", btn: "Enviar" },
  ...
  ru: {
    ...
    contact: { title1: "Давайте", title2: "начнем диалог.", desc: "Свяжитесь с нами для консультации.", email: "Email", visit: "Адрес", f_name: "Имя", f_mail: "Email", f_subj: "Тема", f_msg: "Сообщение", btn: "Отправить" },
